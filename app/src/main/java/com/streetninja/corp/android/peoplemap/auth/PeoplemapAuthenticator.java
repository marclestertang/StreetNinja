...
public class PeoplemapAuthenticator extends AbstractAccountAuthenticator {

    public final static String TAG = PeoplemapAuthenticator.class.getSimpleName();

    private Context mContext;

    public PeoplemapAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    ...
                    authToken = AuthenticationServerRequest.syncUserSignIn(mContext, account.name,
                            password, authTokenType, new AuthenticationServerRequest.ResponseListener() {
                        @Override
