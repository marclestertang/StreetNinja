...
/**
 * Created by marctang on 3/24/15.
 */
public class NocLinearLayout extends LinearLayout {
  ...
  public NocLinearLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
    ...
    mShowDividers = a
        .getInt(/*com.android.internal.R.styleable.*/LinearLayout_showDividers, SHOW_DIVIDER_NONE);
    mDividerPadding = a
        .getDimensionPixelSize(/*com.android.internal.R.styleable.*/LinearLayout_dividerPadding, 0);
    mUseLargestChild = a
   ...
   * #SHOW_DIVIDER_MIDDLE}, or {@link #SHOW_DIVIDER_END}, or {@link #SHOW_DIVIDER_NONE} to show no
   * dividers.
   */
  ...
  /**
   * When true, all children with a weight will be considered having the minimum size of the largest
   * child. If false, all children are measured normally.
   *
   * @return True to measure children with a weight using the minimum size of the largest child,
   * false otherwise.
  ...
  /**
   * When set to true, all children with a weight will be considered having the minimum size of the
   * largest child. If false, all children are measured normally.
   *
   * Disabled by default.
   *
